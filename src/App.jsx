    ...
    <div style={{ width: "100vw", minHeight: "100vh", backgroundColor: "#f8fafc", paddingBottom: "180px", boxSizing: "border-box", overflowX: "hidden" }}>
        ...
        <div style={{ background: "linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%)", padding: "50px 30px", borderRadius: "35px", color: "white", boxShadow: "0 20px 40px rgba(37, 99, 235, 0.3)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "30px" }}>
            ...
            <input 
              ...
              style={{ width: "140px", fontSize: "40px", background: "rgba(255,255,255,0.2)", border: "none", color: "white", textAlign: "right", borderRadius: "12px", padding: "10px" }} 
            />
          </div>
      ...
      <div style={{ backgroundColor: "white", width: "100%" }}>
        {dates.map(date => {
          ...
          return (
            <div key={date} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "35px 40px", borderBottom: "2px solid #f1f5f9", backgroundColor: isToday ? "#eff6ff" : "white" }}>
              <div style={{ flex: 1 }}>
              ...
              {!holiday && !isWeekend ? (
                <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                  <input 
                    ...
                    style={{ width: "160px", height: "90px", fontSize: "40px", textAlign: "right", border: "4px solid #e2e8f0", borderRadius: "20px", padding: "0 20px", outline: "none" }}
                    placeholder="0:00"
                  />
                  <button 
                    onClick={() => setHours({ ...hours, [date]: "" })}
                    style={{ width: "80px", height: "90px", fontSize: "36px", background: "#f8fafc", border: "2px solid #e2e8f0", borderRadius: "20px", color: "#94a3b8" }}
                  >
                    🔄
                  </button>
                </div>
